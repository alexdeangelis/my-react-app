function PrivacyPolicy() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to alexdeangelis.me.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to alexdeangelis.me, accessible from{' '}
            <a
              href='https://www.alexdeangelis.me/'
              rel='external nofollow noopener noreferrer'
              target='_blank'
            >
              https://www.alexdeangelis.me/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: alexdeangelis86@gmail.com</li>
      </ul>
    </>
  )
}
